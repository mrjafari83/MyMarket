...
namespace Persistance.Migrations
{
    ...
    [Migration("20220216103339_Edit_Relations_In_Product_And_BlogPage")]
    partial class Edit_Relations_In_Product_And_BlogPage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BlogPages.BlogPage", b =>
                {
                    ...
                    b.Property<int?>("Keyword<BlogPage>Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Keyword<BlogPage>Id");

                    b.ToTable("BlogPages");
                });

            modelBuilder.Entity("Domain.Entities.BlogPages.KeywordInBlogPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("Keyword<KeywordInBlogPage>Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Keyword<KeywordInBlogPage>Id");

                    b.HasIndex("KeywordId");

                    b.ToTable("KeywordsInBlogPages");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Common.Keyword<Domain.Entities.BlogPages.BlogPage>", b =>
                {
                    ...
                    b.ToTable("Keyword<BlogPage>");
                });

            modelBuilder.Entity("Domain.Entities.Common.Keyword<Domain.Entities.BlogPages.KeywordInBlogPage>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Entities.Common.Keyword<Domain.Entities.Products.Product>", b =>
                {
                    ...
                    b.ToTable("Keyword<Product>");
                });

            modelBuilder.Entity("Domain.Entities.Common.Keyword<Domain.Entities.Products.Relations.KeywordInProduct>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Entities.Products.Product", b =>
                {
                    ...
                    b.Property<int?>("Keyword<Product>Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Relations.FeatureInProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("FeaturesInProducts");
                });

            modelBuilder.Entity("Domain.Entities.Products.Relations.KeywordInProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("Keyword<KeywordInProduct>Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Keyword<KeywordInProduct>Id");

                    b.HasIndex("KeywordId");

                    b.HasIndex("ProductId");

                    b.ToTable("KeywordsInProducts");
                });
            ...
            modelBuilder.Entity("Domain.Entities.BlogPages.BlogPage", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Common.Keyword<Domain.Entities.BlogPages.BlogPage>", null)
                        .WithMany("Parent")
                        .HasForeignKey("Keyword<BlogPage>Id");
            ...
            modelBuilder.Entity("Domain.Entities.BlogPages.KeywordInBlogPage", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Common.Keyword<Domain.Entities.BlogPages.KeywordInBlogPage>", null)
                        .WithMany("Parent")
                        .HasForeignKey("Keyword<KeywordInBlogPage>Id");

                    b.HasOne("Domain.Entities.Common.Keyword<Domain.Entities.BlogPages.BlogPage>", "Keyword")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Products.Product", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Common.Keyword<Domain.Entities.Products.Product>", null)
                        .WithMany("Parent")
                        .HasForeignKey("Keyword<Product>Id");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Relations.FeatureInProduct", b =>
                {
                    b.HasOne("Domain.Entities.Products.ProductFeature", "Feature")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Domain.Entities.Products.Relations.KeywordInProduct", b =>
                {
                    b.HasOne("Domain.Entities.Common.Keyword<Domain.Entities.Products.Relations.KeywordInProduct>", null)
                        .WithMany("Parent")
                        .HasForeignKey("Keyword<KeywordInProduct>Id");

                    b.HasOne("Domain.Entities.Common.Keyword<Domain.Entities.Products.Product>", "Keyword")
                        .WithMany()
                        .HasForeignKey("KeywordId");
